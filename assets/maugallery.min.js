(function (a) {
  (a.fn.mauGallery = function (b) {
    var b = a.extend(a.fn.mauGallery.defaults, b),
      c = [];
      ...
      a.fn.mauGallery.methods.createRowWrapper(a(this)),
        ...
        a(this)
          ...
          .each(function () {
            ...
            var d = a(this).data("gallery-tag");
            b.showTags && d !== void 0 && -1 === c.indexOf(d) && c.push(d);
          }),
        b.showTags &&
    ...
    (a.fn.mauGallery.methods = {
      ...
      wrapItemInColumn(a, b) {
        if (b.constructor === Number)
          a.wrap(
            `<div class='item-column mb-4 col-${Math.ceil(12 / b)}'></div>`
          );
        else if (b.constructor === Object) {
          var c = "";
          b.xs && (c += ` col-${Math.ceil(12 / b.xs)}`),
            b.sm && (c += ` col-sm-${Math.ceil(12 / b.sm)}`),
            b.md && (c += ` col-md-${Math.ceil(12 / b.md)}`),
            b.lg && (c += ` col-lg-${Math.ceil(12 / b.lg)}`),
            b.xl && (c += ` col-xl-${Math.ceil(12 / b.xl)}`),
            a.wrap(`<div class='item-column mb-4${c}'></div>`);
        } else
          console.error(
            `Columns should be defined as numbers or objects. ${typeof b} is not supported.`
          );
      },
      ...
      openLightBox(b, c) {
        a(`#${c}`).find(".lightboxImage").attr("src", b.attr("src")),
          a(`#${c}`).modal("toggle");
      },
      prevImage() {
        let b = null;
        ...
        let c = a(".tags-bar span.active-tag").data("images-toggle"),
          d = [];
        "all" === c
      ...
      showItemTags(b, c, d) {
        ...
        a.each(d, function (a, b) {
          e += `<li class="nav-item active">
                <span class="nav-link"  data-images-toggle="${b}">${b}</span></li>`;
        });
